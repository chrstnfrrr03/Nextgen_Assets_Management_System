...
<?php $__env->startSection('content'); ?>
    ...
    <div class="grid grid-cols-1 gap-4 mb-6 md:grid-cols-4">
        <div class="p-5 bg-white border shadow-sm rounded-2xl border-slate-200">
            ...
            <h2 class="mt-2 text-3xl font-bold text-slate-900"><?php echo e($users->total()); ?></h2>
        </div>
    ...
    <div class="p-4 mb-6 bg-white border shadow-sm rounded-2xl border-slate-200">
        <form method="GET" action="<?php echo e(route('users.index')); ?>" class="flex flex-col gap-3 md:flex-row">
                        ...
                        <tr class="transition hover:bg-slate-50/80">
                            <td class="px-4 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div class="font-semibold text-slate-900"><?php echo e($user->name); ?></div>
                            ...
                            <td class="px-4 py-4 text-slate-700"><?php echo e($user->email); ?></td>

                            <td class="px-4 py-4">
                                <span
                                    class="inline-flex rounded-full bg-slate-100 px-2.5 py-1 text-xs font-semibold text-slate-700">
                                    <?php echo e($user->role === 'admin' ? 'System Administrator' : ucfirst(str_replace('_', ' ', $user->role))); ?>

                                </span>
                            </td>

                            <td class="px-4 py-4 text-slate-700"><?php echo e($user->assignments_count); ?></td>
                            <td class="px-4 py-4 text-slate-700"><?php echo e($user->active_assignments_count); ?></td>
                            <td class="px-4 py-4 text-slate-700"><?php echo e($user->asset_logs_count); ?></td>
                            ...
                            <td class="px-4 py-4">
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <?php if(auth()->id() !== $user->id): ?>
                                        <form method="POST" action="<?php echo e(route('users.impersonate', $user)); ?>">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit"
